...
/**
 * Class for displaying the video stream from the Bebop onto a surface view
 *
 * This is the view element that is used on the layout
 *
 * taken from Parrot SDK sample
 */
